...
public class IncomeTax  {
    ...
    public static void main(String[] args)  {
        ...
        if (input.hasNextInt()) {
            ...
            if (incomeInThousands < 20 && incomeInThousands >= 0) {
            ...
            if (incomeInThousands >= 20 && incomeInThousands < 40); {
            ...
            //  if the user's income is greater than or equal to $40,000 and less than $78,000
                if (incomeInThousands >= 40 && incomeInThousands < 78); {
